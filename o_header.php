...
<div align="center" id="navigationLinks">
    <?PHP    
        ...
        echo('<strong>Horse Actions</strong>| 
                        <a href="horseEdit.php?formAction=searchHorse"><u>Search Horse</u></a>,
                        <a href="horseEdit.php?formAction=addHorse"><u>Add Horse</u></a>, 
                        <a href="horseEdit.php?formAction=selectHorse"><u>Edit Horse</u></a>,
    ...
    */
        ...
        /*
        $permission_array['owen_index.php'] = 0;
        ...
        if($permission_array[$current_page]>$_SESSION['access_level']){
            ...
            echo "<script type=\"text/javascript\">window.location = \"owen_index.php\";</script>";
        ...
        if ($_SESSION['venue'] =="") { 
	        ...
	        if ($_SESSION['access_level'] >= 1) {
	        	echo('<a href="' . $path . 'owen_index.php">home</a>');
	        	echo(' | <a href="' . $path . 'about.php">about</a>');
	            echo(' | <a href="' . $path . 'help.php?helpPage=' . $current_page . '" target="_BLANK">help</a>');
	            echo(' | calendars: <a href="' . $path . 'calendar.php?venue=portland'.''.'">Portland, </a>');
	            echo(' <a href="' . $path . 'calendar.php?venue=bangor'.''.'">Bangor</a>');
